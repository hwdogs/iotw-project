...
import org.example.entity.vo.request.AccountEmailRestVO;
...
public class AuthorizeController {
    ...
    public RestBean<Void> askVerifyCode(@RequestParam @Email String email,
        ...
        return responseUtils.messageHandle(() -> service.registerEmailVerifyCode(type, email, request.getRemoteAddr()));
    }
    ...
    public RestBean<Void> register(@RequestBody AccountEmailRegisterVO vo) {
    ...
    public RestBean<Void> resetPassword(@RequestBody AccountEmailRestVO vo) {
